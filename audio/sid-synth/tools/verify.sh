...
# Corpus: song-file:subtunes. BOTH songs are our own work - no third-party
...
# transposes and 8xy/Axy/Fxy commands. Both are deterministic, so regenerating
# them yields identical bytes and the golden dumps stay valid.
CORPUS=(
